...
import { createPost, getFeedPosts, getPost, likePost, addComment, getComments, searchPosts, reportPost } from "../../controllers/postControllers.js";
...
postRouter.post("/uploadImage", verifyJWT,  upload.single("image"), uploadPostImageToS3, (req, res) => {
  // @ts-ignore
